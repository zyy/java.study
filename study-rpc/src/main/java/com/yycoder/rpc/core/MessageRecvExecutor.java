...
import com.yycoder.rpc.msg.MessageKeyValue;
...
public class MessageRecvExecutor implements ApplicationContextAware, InitializingBean {
    ...
    public void setApplicationContext(ApplicationContext ctx) throws BeansException {
        try {
            MessageKeyValue keyVal = (MessageKeyValue) ctx.getBean(Class.forName("com.snack.rpc.msg.MessageKeyValue"));
            Map<String, Object> rpcServiceObject = keyVal.getMessageKeyValue();
